...
class RestaurantDetailsScrn extends StatefulWidget {
  static const routeName = '/restaurant_details';
  final RestaurantModel detailRestaurant;
  const RestaurantDetailsScrn({super.key, required this.detailRestaurant});

  @override
  _RestaurantDetailsScrnState createState() => _RestaurantDetailsScrnState();
}

class _RestaurantDetailsScrnState extends State<RestaurantDetailsScrn> {
  @override
